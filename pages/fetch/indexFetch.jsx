...
import { fetchDeleteData, fetchEditData, fetchGetData, fetchPostData } from "../../api/fetchAPI";
import Card from "../../components/Card";
import FormsModal from "../../components/Modal/FormsModal";
import ModalContainer from "../../components/Modal/ModalContainer";

export default function IndexFetch() {
    const defaultData = {
        "id": 0,
        "name": "",
        "username": "",
    ...
    async function handleEdit(e){
        e.preventDefault();
            if(selectedData.id < 10){
                const responseAPI = await fetchEditData(selectedData);
    ...
    async function handleSubmit(e){
        e.preventDefault();
        let responseAPI = await fetchPostData(selectedData);
    ...
    async function handleDelete(selectedDataId){
        const responseAPI = await fetchDeleteData(selectedDataId);
